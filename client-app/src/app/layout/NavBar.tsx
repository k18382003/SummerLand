                    ...
                    <div className="ui fixed inverted menu">
                        <div className="ui container">
                            ...
                            </a>
                            {
                                isLoggedIn ? (
                                    <>
                                    <a href="/articles"  className="ui simple dropdown item">
                                        Articles 
                                    </a>
                                    ...
                                    <div className="right menu">
                                        <Image src={require('../../images/user.png')} avatar style={{top:10, right:10}}/>
                    ...
                    </li>
                    {
                        ...
                        (
                            <>
                                ...
                                <Segment>
                                    <Image src={require('../../images/user.png')} avatar  floated='left'/>
