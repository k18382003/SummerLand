...
namespace Application.PhotoAccessor_Azure
{
    public class PhotoAccessor_Azure : IPhotos
    {
        ...
        public PhotoAccessor_Azure(IOptions<AzureSetting> config, IUserAccessor user)
        {
